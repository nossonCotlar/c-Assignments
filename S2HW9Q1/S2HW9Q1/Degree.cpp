...
std::string BA::studType() const { return "BA"; }
float BA::avg() const {
	float sum = 0;
...
std::string MA::studType() const { return "MA"; }
...
std::string PHD::studType() const { return "PHD"; }
int PHD::getHours() const { return hours; }